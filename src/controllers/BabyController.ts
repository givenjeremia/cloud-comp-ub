...
class BabyController extends Controller {
    ...
    public routes(): void {
        ...
        // UAS
        this.router.get("/get-baby-name-by-origin", this.getBabyNameByOrigin);
        this.router.get("/get-baby-name-first-letter", this.getBabyNameFirstLetter);
        this.router.get("/get-baby-name-meaning", this.getBabyNameMeaning);
    ...
    public async getBabyNameFirstLetter(req: Request, res: Response): Promise<Response> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) return super.badRequest(res, "invalid request", errors.array());
    
            const firstLetter = req.query.firstLetter as string || null;
    ...
    public async getBabyNameMeaning(req: Request, res: Response): Promise<Response> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) return super.badRequest(res, "invalid request", errors.array());
    
            const meaning = req.query.meaning as string || null;
